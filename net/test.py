...
gps=3
blocks=19
img_dir='data/Foggy_Driving_COCO/JPEGImages/' 
output_dir='data/Foggy_Driving_COCO_ffa/JPEGImages/' 
print("pred_dir:",output_dir)                                                                               # frankfurt lindau munster 
...
for im in os.listdir(img_dir):
    ...
    vutils.save_image(ts,output_dir+im.split('.')[0]+'.'+im.split('.')[1]) # _FFA.png
